...
public class NoMatchSize extends ItemInfoState {

    public NoMatchSize(ClotheInfo clotheInfo, StateSettable stateSettable, FragmentItemInfoBinding binding) {
        ...
        binding.itemInfoAddToCartBtn.setText(R.string.item_info_no_match_size);
