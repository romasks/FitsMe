...
public class RateItemsDetailTouchListener implements View.OnTouchListener  {

    private static final long MAX_CLICK_DURATION = 250;

    private RateItemsDetailTouchListener.Callback callback;
    ...
    public RateItemsDetailTouchListener(RateItemsDetailFragment fragment){
